...
### Развертывание в Kubernetes системы мониторинга производится по аналогии с тестовым приложением.
### Для каждого из приложения системы мониторинга создан соответствующий каталог с Helm Chart
